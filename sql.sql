...
-- Dumping database structure for kratom
CREATE DATABASE IF NOT EXISTS `kratom` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `kratom`;

-- Dumping structure for table kratom.amphures
...
-- Dumping data for table kratom.amphures: 998 rows
...
-- Dumping structure for table kratom.districts
...
-- Dumping data for table kratom.districts: 8,849 rows
...
-- Dumping data for table kratom.infouser: ~3 rows (approximately)
/*!40000 ALTER TABLE `infouser` DISABLE KEYS */;
INSERT INTO `infouser` (`id_user`, `national_id`, `address`, `sub_area`, `area`, `province`, `postcode`, `tel`, `email`) VALUES
	(9, '1909900155122', 'dd', 'dd', 'kd', 'ld', '12365', '0214789635', 'kkkk@ss.cc'),
	(12, '1809700376568', '222', 'บ้านพร้าว', 'ป่าพะยอม', 'พัทลุง', '93210', '0622266723', '622021104@tsu.ac.th'),
	(15, '1809700376568', '222', 'บ้านพร้าว', 'ป่าพะยอม', 'พัทลุง', '93210', '0622266723', 'filmm09615@gmail.com');
/*!40000 ALTER TABLE `infouser` ENABLE KEYS */;

-- Dumping structure for table kratom.petition
...
-- Dumping structure for table kratom.planting
...
-- Dumping data for table kratom.planting: ~3 rows (approximately)
...
-- Dumping structure for table kratom.provinces
...
-- Dumping data for table kratom.provinces: 77 rows
...
-- Dumping structure for table kratom.user
...
-- Dumping data for table kratom.user: ~5 rows (approximately)
